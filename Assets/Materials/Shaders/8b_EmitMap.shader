...
Shader "unityCookie/tut/beginner/8b - Emit Map"
{
	Properties
	{
		...
		_EmitStrength("Emition Strength", Range(0, 2.0)) = 0
		...
		SubShader
		{
			...
			Pass
			{
				...
				float4 frag(vertexOutput i) : COLOR
				{
					...
					float3 lightFinal = diffuseReflection + (specularReflection * tex.a) + rimLighting; // deleted  UNITY_LIGHTMODEL_AMBIENT.xyz + 
